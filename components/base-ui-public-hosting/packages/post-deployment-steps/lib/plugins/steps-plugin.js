...
import CreateCloudFrontInterceptor from '../steps/create-cloudfront-interceptor';
import UpdateCloudFrontWafIpRules from '../steps/update-cloudfront-waf-ip-rules';
...
async function getSteps(existingStepsMap, pluginRegistry) {
  const stepsMap = new Map([
    ...
    ['updateCloudFrontWafIpRules', new UpdateCloudFrontWafIpRules()],
  ]);
