...
class DbScanner {
  ...
  // Get a single page of results, by default from the beginning, or from the optionally specified start()
  async scanPage(nextToken) {
    if (!this.params.Limit) {
      throw new Error('DbQuery.scanPage() Limit was not set. Must specify a limit before performing a page scan');
    }
