...
import EnableAppstreamUsageReports from '../steps/enable-appstream-usage-reports';
/**
...
async function getSteps(existingStepsMap, pluginRegistry) {
  const stepsMap = new Map([...existingStepsMap, ['enableAppstreamUsageReports', new EnableAppstreamUsageReports()]]);
