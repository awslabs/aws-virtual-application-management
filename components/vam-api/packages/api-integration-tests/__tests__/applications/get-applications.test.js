...
describe('Get appstream-applications scenarios', () => {
  let setup;
  let adminSession;
  ...
  describe('Get application list', () => {
    it('should fail for anonymous user', async () => {
      const anonymousSession = await setup.createAnonymousSession();

      await expect(anonymousSession.resources.applications.get()).rejects.toMatchObject({
    ...
    it('should fail for guest user', async () => {
      ...
      await expect(guestSession.resources.applications.get()).rejects.toMatchObject({
    ...
    it('should succeed for power user', async () => {
      ...
      await expect(powerUserSession.resources.applications.get()).resolves.toBeDefined();
    });

    it('should succeed for admin user', async () => {
      await expect(adminSession.resources.applications.get()).resolves.toBeDefined();
    });
  });
});
