...
describe('Create (post) appstream-fleets scenarios', () => {
  let setup;
  let adminSession;
  ...
  describe('create fleet', () => {
    it('should fail for anonymous user', async () => {
      ...
      await expect(
        anonymousSession.resources.fleets.create({}, {}, { api: '/api/appstream-fleets/create', applyDefault: true }),
    ...
    it('should fail for guest user', async () => {
      ...
      await expect(
        guestSession.resources.fleets.create({}, {}, { api: '/api/appstream-fleets/create', applyDefault: true }),
      ).rejects.toMatchObject({
    ...
    it('should succeed for power user', async () => {
      ...
      await expect(
        powerUserSession.resources.fleets.create({}, {}, { api: '/api/appstream-fleets/create', applyDefault: true }),
      ).resolves.toBeDefined();
    });

    it('should succeed for admin', async () => {
      await expect(
        adminSession.resources.fleets.create({}, {}, { api: '/api/appstream-fleets/create', applyDefault: true }),
      ).resolves.toBeDefined();
    });
  });
});
