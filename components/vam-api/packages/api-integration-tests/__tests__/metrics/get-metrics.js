...
describe('Get appstream-metrics scenarios', () => {
  let setup;
  let adminSession;
  ...
  describe('Get metrics', () => {
    it('should fail for anonymous user', async () => {
      ...
      await expect(anonymousSession.resources.metrics.get()).rejects.toMatchObject({
    ...
    it('should fail for guest user', async () => {
      ...
      await expect(guestSession.resources.metrics.get()).rejects.toMatchObject({
    ...
    it('should succeed for power user', async () => {
      ...
      await expect(powerUserSession.resources.metrics.get()).resolves.toBeDefined();
    });

    it('should succeed for admin user', async () => {
      await expect(adminSession.resources.metrics.get()).resolves.toBeDefined();
    });
  });
});
