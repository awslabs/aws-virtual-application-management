...
describe('Get groups scenarios', () => {
  ...
  describe('Get group list', () => {
    it('should fail for anonymous user', async () => {
      ...
      await expect(anonymousSession.resources.groups.get()).rejects.toMatchObject({
    ...
    it('should fail for guest user', async () => {
      ...
      await expect(guestSession.resources.groups.get()).rejects.toMatchObject({
    ...
    it('should succeed for power user', async () => {
      ...
      await expect(powerUserSession.resources.groups.get()).resolves.toBeDefined();
    });

    it('should succeed for admin user', async () => {
      await expect(adminSession.resources.groups.get()).resolves.toBeDefined();
    });
  });
});
