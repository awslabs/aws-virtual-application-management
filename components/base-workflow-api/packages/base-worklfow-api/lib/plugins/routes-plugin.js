...
import stepTemplateController from '../controllers/step-template-controller';
import workflowTemplateController from '../controllers/workflow-template-controller';
import workflowControllers from '../controllers/workflow-controller';
...
async function getRoutes(routesMap, pluginRegistry) {
  const routes = new Map([
    ...
    ['/api/step-templates', [setupAuthContext, prepareContext, ensureActive, ensureAdmin, stepTemplateController]],
    [
      '/api/workflow-templates',
      [setupAuthContext, prepareContext, ensureActive, ensureAdmin, workflowTemplateController],
    ],
    ['/api/workflows', [setupAuthContext, prepareContext, ensureActive, ensureAdmin, workflowControllers]],
  ]);
