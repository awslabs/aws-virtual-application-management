...
import AddStepTemplates from '../steps/add-step-templates';
import AddWorkflowTemplates from '../steps/add-workflow-templates';
import AddWorkflows from '../steps/add-workflows';
import AddWorkflowTriggers from '../steps/add-workflow-triggers';
...
async function getSteps(existingStepsMap, pluginRegistry) {
  const stepsMap = new Map([
    ...
    ['addWorkflowTriggers', new AddWorkflowTriggers()],
  ]);
