...
import { parseMethodArn, buildRestApiPolicy, newUnauthorizedError, customAuthorizerResponse } from './apigw';
...
export default function newHandler({ authenticationService = noopAuthenticationService, log = consoleLogger } = {}) {
