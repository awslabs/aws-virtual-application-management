...
const { AuthenticationIdTokenNode } = require('./authentication-id-token');

class AuthenticationIdTokensNode extends CollectionResourceNode {
  ...
  idToken(username) {
    return new AuthenticationIdTokenNode({ clientSession: this.clientSession, id: username, parent: this });
  }
...
module.exports = { AuthenticationIdTokensNode };
