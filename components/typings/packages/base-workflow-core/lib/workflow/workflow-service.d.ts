...
declare class WorkflowService {
    ...
    internals: {
        findSteps: any;
        applyOverrideConstraints: any;
    };
    createVersion(requestContext: any, manifest?: {}, { isLatest, tableName }?: {
        isLatest?: boolean;
        tableName: any;
    }): Promise<any>;
    deleteAllWorkflowVersions(requestContext: any, { id }: {
        id: any;
    }): Promise<[any, any, any, any, any, any, any, any, any, any]>;
    deleteWorkflowVersion(_requestContext: any, { id, ver }: {
        id: any;
        ver: any;
    }): Promise<any>;
    prepareWorkflow(workflow: any): Promise<any>;
