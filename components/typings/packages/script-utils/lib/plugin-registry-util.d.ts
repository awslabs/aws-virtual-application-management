...
export class PluginRegistryUtil {
    constructor(registry: any);
    registry: any;
    getPluginsWithMethod(extensionPoint: any, methodName: any): any;
    /**
    ...
    visitPlugins(extensionPoint: any, methodName: any, { payload, continueOnError, pluginInvokerFn, }?: {
        ...
        pluginInvokerFn?: (pluginPayload: any, plugin: any, method: any, ...args: any[]) => any;
    }, ...args: any[]): any;
    /**
     * Similar to {@link visitPlugins} method above except this method supports plugin methods being asynchronous
     * (i.e, it can return promise)
     *
     ...
     * @returns {Promise<*>}
     */
    visitPluginsAsync(extensionPoint: any, methodName: any, { payload, continueOnError, pluginInvokerFn, }?: {
        payload?: {};
        continueOnError?: boolean;
        pluginInvokerFn?: (pluginPayload: any, plugin: any, method: any, ...args: any[]) => Promise<any>;
    }, ...args: any[]): Promise<any>;
    runPlugins(extensionPoint: any, methodName: any, ...args: any[]): Promise<void>;
}
