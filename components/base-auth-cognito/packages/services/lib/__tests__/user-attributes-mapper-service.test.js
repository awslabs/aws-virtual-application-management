...
import UserAttributesMapperService from '../attribute-mapper-service';
...
describe('UserAttributeMapperService', () => {
  ...
  describe('.getEmail', () => {
    it('returns the email field', () => {
      fc.assert(fc.property(fc.string(), email => email === service.getEmail({ email })));
    });
  });

  describe('.getLastName', () => {
    it('returns the family_name field', () => {
      // eslint-disable-next-line camelcase
      fc.assert(fc.property(fc.string(), family_name => family_name === service.getLastName({ family_name })));
    });
  });

  describe('.getFirstName', () => {
    it('returns the given_name field', () => {
      // eslint-disable-next-line camelcase
      fc.assert(fc.property(fc.string(), given_name => given_name === service.getFirstName({ given_name })));
    });
  });
});
