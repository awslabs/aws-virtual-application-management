...
import inputSchema from './create-cognito-user-pool-schema.json';
...
export default {
  ...
  config: {
    ...
    impl: {
      ...
      tokenValidatorLocator: 'locator:service:cognitoProviderService/validateToken',
      ...
      tokenRevokerLocator: 'locator:service:cognitoProviderService/revokeToken',
      ...
      provisionerLocator: 'locator:service:cognitoProvisionerService/provision',
    },
  },
};
