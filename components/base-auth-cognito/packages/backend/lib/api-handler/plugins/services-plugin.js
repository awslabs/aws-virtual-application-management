...
} from '@aws-ee/base-auth-cognito-services';
...
async function registerServices(container, pluginRegistry) {
  container.register('cognitoAttributeMapperService', new CognitoAttributeMapperService());
  container.register('cognitoUserManagementService', new CognitoUserManagementService());
  container.register('cognitoProviderService', new CognitoProviderService());
}
