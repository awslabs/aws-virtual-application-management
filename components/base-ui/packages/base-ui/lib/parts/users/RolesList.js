...
class RolesList extends React.Component {
  ...
  get userRoles() {
    const store = this.userRolesStore;
    return store.list;
  }

  renderMain() {
    const userRolesData = this.userRoles;
      ...
      <div>
        <ReactTable
          ...
          columns={[
            ...
            {
              Header: 'Capabilities',
              accessor: 'capabilities', // TODO: implement a details modal to show the list of all capabilities
            },
          ]}
        />
        <br />
  ...
  renderTotal() {
    return <Label circular>{this.userRoles.length}</Label>;
  }
