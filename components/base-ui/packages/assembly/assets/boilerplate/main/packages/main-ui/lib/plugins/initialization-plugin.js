 ...
 * It is unlikely that you will need to do so because the base-ui component takes care of the most common initialization
 * logic needed.
 *
 * @param payload A free form object. Use this object to add any properties that you need to pass to the App model
 * when it is being initialized. The base-ui component, makes a property named 'tokenInfo' available on this payload object.
