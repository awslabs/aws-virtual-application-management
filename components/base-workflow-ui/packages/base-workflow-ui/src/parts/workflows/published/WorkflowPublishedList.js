...
import whiteGradient from '../../../images/white-gradient.png'; // We need this because we are getting the image from src and not dist
    ...
    return (
      <>
        <div className="overflow-hidden height-60-px">
          <ReactMarkdown rehypePlugins={[rehypeRaw, rehypeSanitize]}>{latest.desc}</ReactMarkdown>
        </div>
